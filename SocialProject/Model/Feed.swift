            ...
            if let attachments = attachments {
                ...
                for _ in 0..<attachmentsCount {
                    ...
                    for z in 0..<sizesCount {
                        ...
                        if z == sizesCount-1 {
                            let news = News(sourceID: sourceID, text: text, date: date, photoURL: url, commentCount: commentsCount, likesCount: likesCount, isUserLikes: isUserLikesBool, repostCount: repostsCount, viewsCount: viewsCount)
