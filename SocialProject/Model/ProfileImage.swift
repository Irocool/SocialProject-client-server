...
//  SocialProject
//
//  Created by Irina Kuligina on 28.11.2021.
//
...
class ImageList: Decodable {
    ...
    required init(from decoder: Decoder) throws {
        ...
        for _ in 0..<itemsCount {
            ...
            //let userImage1 = Image(ownerID: ownerID, albumID: albumID, id: id, date: date, text: text, likes: likes, reposts: repostsCount, photo50: photo50, photo100: photo100, photo200: photo200)
